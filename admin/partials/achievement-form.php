...
<form method="post" enctype="multipart/form-data" class="admin-form">
    <div class="form-grid">
        <div class="form-group">
            <label for="title">Judul Prestasi <span class="required">*</span></label>
            <input type="text" id="title" name="title" value="<?= e($val('title')) ?>" required>
        </div>
        <div class="form-group">
            <label for="year">Tahun <span class="required">*</span></label>
            <input type="text" id="year" name="year" value="<?= e($val('year')) ?>" placeholder="2025" required>
        </div>
    ...
    <div class="form-actions">
        <a href="<?= e(adminUrl('achievements/index.php')) ?>" class="btn btn-secondary">Batal</a>
